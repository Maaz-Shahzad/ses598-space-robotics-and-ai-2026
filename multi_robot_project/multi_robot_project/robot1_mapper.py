...
#        self.create_subscription(Odometry,'/robot1/odom',self.odom_callback,10)
        self.r1_odom_sub = Subscriber(self, Odometry, '/robot1/odom')
        
        # Synchronize Robot 1's RGB and Depth
        self.r1_sync = ApproximateTimeSynchronizer(
            [self.r1_rgb_sub, self.r1_depth_sub, self.r1_odom_sub],
            queue_size=3,
...
#        self.create_subscription(CameraInfo, '/robot2/camera/camera_info',self.r2_info_cb, 10)
        ...
        self.log_file = 'robot1_map_data.csv'
...
#        z = depth
    ...
    def robot1_callback(self, rgb_msg, depth_msg, odom_msg):
